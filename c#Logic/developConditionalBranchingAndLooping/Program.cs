...
switch (menuSelection)
{
    ...
    while (anotherPet == "y" && petCount < maxPets)
    {
      ...
      do
      {
        ...
        if (readResult != null)
        {
          ...
          {
            Console.WriteLine($"Invalid entry: {animalSpecies}. Please try again.");
          }
        }
      ...
      // Prompt for the pet's age, which can be unknown
      do
      {
        int petAge;
      ...
      // Prompt for the pet's physical description
      do
      {
      ...
      // Prompt for the pet's personality description
      do
      {
  ...
  case "exit":
    ...
    break;
  default:
    Console.WriteLine($"Invalid selection: {menuSelection}. Please try again.");
    break;
}
